    ...
    <form method="post" class="col-md-8 mx-auto">
        ...
        <?php endif ?>
            <div class="row m-2">
                ...
                <input class="col-8" type="text" name="firstname" id="firstname" value="<?= $data['user']['firstname']?>" required>
            </div>
            <div class="row m-2">
                <label class="col-4" for="name">Nom</label>
                <input class="col-8" type="text" name="name" id="name" value="<?= $data['user']['name']?>" required>
            </div>
            <div class="row m-2">
